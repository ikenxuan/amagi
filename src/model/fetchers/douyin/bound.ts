...
export interface IBoundDouyinFetcher {
  ...
  /** 获取抖音视频作品数据 */
  fetchVideoWork: {
    (options: DouyinWorkOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['视频作品数据']>>
    (options: DouyinWorkOptions): Promise<Result<any>>
  }

  /** 获取抖音图集作品数据 */
  fetchImageAlbumWork: {
    (options: DouyinWorkOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['图集作品数据']>>
    (options: DouyinWorkOptions): Promise<Result<any>>
  }

  /** 获取抖音合辑作品数据 */
  fetchSlidesWork: {
    (options: DouyinWorkOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['合辑作品数据']>>
    (options: DouyinWorkOptions): Promise<Result<any>>
  }

  /** 获取抖音文字作品数据 */
  fetchTextWork: {
    (options: DouyinWorkOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['文字作品数据']>>
    (options: DouyinWorkOptions): Promise<Result<any>>
  }

  /** 聚合解析抖音作品数据 (自动识别作品类型) */
  parseWork: {
    (options: DouyinWorkOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['聚合解析']>>
    (options: DouyinWorkOptions): Promise<Result<any>>
  }

  /** 获取抖音视频弹幕数据 */
  fetchDanmakuList: {
    (options: DouyinDanmakuOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['弹幕数据']>>
  ...
  /** 获取抖音作品评论数据 */
  fetchWorkComments: {
    (options: DouyinCommentsOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['评论数据']>>
    (options: DouyinCommentsOptions): Promise<Result<any>>
  }

  /** 获取抖音指定评论的回复数据 */
  fetchCommentReplies: {
    (options: DouyinCommentRepliesOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['指定评论回复数据']>>
  ...
  /** 获取抖音用户主页数据 */
  fetchUserProfile: {
    (options: DouyinUserOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['用户主页数据']>>
    (options: DouyinUserOptions): Promise<Result<any>>
  }

  /** 获取抖音用户视频列表数据 */
  fetchUserVideoList: {
    (options: DouyinUserOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['用户主页视频列表数据']>>
    (options: DouyinUserOptions): Promise<Result<any>>
  }
  ...
  /** 抖音搜索内容 */
  searchContent: {
    (options: DouyinSearchOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['搜索数据']>>
    (options: DouyinSearchOptions): Promise<Result<any>>
  }

  /** 获取抖音热词/搜索建议 */
  fetchSuggestWords: {
    (options: DouyinSuggestWordsOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['热点词数据']>>
  ...
  /** 获取抖音音乐数据 */
  fetchMusicInfo: {
    (options: DouyinMusicOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['音乐数据']>>
    (options: DouyinMusicOptions): Promise<Result<any>>
  }

  /** 获取抖音直播间信息 */
  fetchLiveRoomInfo: {
    (options: DouyinLiveRoomOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['直播间信息数据']>>
    (options: DouyinLiveRoomOptions): Promise<Result<any>>
  }

  /** 申请抖音登录二维码 */
  requestLoginQrcode: {
    (options: DouyinQrcodeOptions & { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['申请二维码数据']>>
    (options: DouyinQrcodeOptions): Promise<Result<any>>
  }

  /** 获取抖音表情列表 */
  fetchEmojiList: {
    (options: { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['Emoji数据']>>
    (options?: BaseRequestOptions): Promise<Result<any>>
  }

  /** 获取抖音动态表情列表 */
  fetchDynamicEmojiList: {
    (options: { typeMode: 'strict' }): Promise<Result<DouyinReturnTypeMap['动态表情数据']>>
    (options?: BaseRequestOptions): Promise<Result<any>>
  }
}
