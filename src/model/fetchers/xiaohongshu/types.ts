...
export interface IXiaohongshuFetcher {
  ...
  ) => Promise<Result<ConditionalReturnType<XiaohongshuDataOptionsMap['首页推荐数据']['data'], M>>>
  ...
  fetchNoteDetail: <M extends TypeMode = 'loose'>(
    ...
    cookie?: string,
    requestConfig?: RequestConfig
  ) => Promise<Result<ConditionalReturnType<XiaohongshuDataOptionsMap['单个笔记数据']['data'], M>>>
  ...
  fetchNoteComments: <M extends TypeMode = 'loose'>(
    ...
    cookie?: string,
    requestConfig?: RequestConfig
  ) => Promise<Result<ConditionalReturnType<XiaohongshuDataOptionsMap['评论数据']['data'], M>>>
  ...
  searchNotes: <M extends TypeMode = 'loose'>(
    ...
    cookie?: string,
    requestConfig?: RequestConfig
  ) => Promise<Result<ConditionalReturnType<XiaohongshuDataOptionsMap['搜索笔记']['data'], M>>>
  ...
  fetchEmojiList: <M extends TypeMode = 'loose'>(
    ...
    cookie?: string,
    requestConfig?: RequestConfig
  ) => Promise<Result<ConditionalReturnType<XiaohongshuDataOptionsMap['表情列表']['data'], M>>>
}
...
export interface IBoundXiaohongshuFetcher {
  /** 获取小红书首页推荐数据 */
  fetchHomeFeed: {
    (options: XiaohongshuHomeFeedOptions & { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['首页推荐数据']['data']>>
    (options?: XiaohongshuHomeFeedOptions): Promise<Result<any>>
  }

  /** 获取小红书笔记详情 */
  fetchNoteDetail: {
    (options: XiaohongshuNoteDetailOptions & { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['单个笔记数据']['data']>>
    (options: XiaohongshuNoteDetailOptions): Promise<Result<any>>
  }

  /** 获取小红书笔记评论数据 */
  fetchNoteComments: {
    (options: XiaohongshuCommentsOptions & { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['评论数据']['data']>>
    (options: XiaohongshuCommentsOptions): Promise<Result<any>>
  }

  /** 获取小红书用户主页数据 */
  fetchUserProfile: {
    (options: XiaohongshuUserProfileOptions & { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['用户数据']['data']>>
    (options: XiaohongshuUserProfileOptions): Promise<Result<any>>
  }

  /** 获取小红书用户笔记列表 */
  fetchUserNoteList: {
    (options: XiaohongshuUserNotesOptions & { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['用户笔记数据']['data']>>
    (options: XiaohongshuUserNotesOptions): Promise<Result<any>>
  }

  /** 搜索小红书笔记 */
  searchNotes: {
    (options: XiaohongshuSearchNotesOptions & { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['搜索笔记']['data']>>
    (options: XiaohongshuSearchNotesOptions): Promise<Result<any>>
  }

  /** 获取小红书表情列表 */
  fetchEmojiList: {
    (options: { typeMode: 'strict' }): Promise<Result<XiaohongshuDataOptionsMap['表情列表']['data']>>
