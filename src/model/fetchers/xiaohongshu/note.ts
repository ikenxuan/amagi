...
export async function fetchHomeFeed<M extends TypeMode = 'loose'> (
  ...
  return fetchXiaohongshuInternal('首页推荐数据', options, { cookie, requestConfig })
}
...
export async function fetchNoteDetail<M extends TypeMode = 'loose'> (
  ...
  return fetchXiaohongshuInternal('单个笔记数据', options, { cookie, requestConfig })
}
...
export async function fetchNoteComments<M extends TypeMode = 'loose'> (
  ...
  return fetchXiaohongshuInternal('评论数据', options, { cookie, requestConfig })
}
