...
export const DouyinApiRoutes = {
  // 作品相关
  fetchVideoWork: '/api/douyin/works/video/:aweme_id',
  fetchImageAlbumWork: '/api/douyin/works/image-album/:aweme_id',
  fetchSlidesWork: '/api/douyin/works/slides/:aweme_id',
  fetchTextWork: '/api/douyin/works/text/:aweme_id',
  parseWork: '/api/douyin/works/parse/:aweme_id',

  // 评论相关
  fetchWorkComments: '/api/douyin/works/:aweme_id/comments',
  fetchCommentReplies: '/api/douyin/works/:aweme_id/comments/:comment_id/replies',

  // 用户相关
  fetchUserProfile: '/api/douyin/users/:sec_uid/profile',
  fetchUserVideoList: '/api/douyin/users/:sec_uid/videos',

  // 搜索相关
  searchContent: '/api/douyin/search',
  fetchSuggestWords: '/api/douyin/search/suggestions',

  // 音乐相关
  fetchMusicInfo: '/api/douyin/music/:music_id',

  // 直播相关
  fetchLiveRoomInfo: '/api/douyin/live/rooms/:room_id',

  // 认证相关
  requestLoginQrcode: '/api/douyin/auth/qrcode/request',

  // 表情相关
  fetchEmojiList: '/api/douyin/emojis',
  fetchDynamicEmojiList: '/api/douyin/emojis/dynamic',

  // 弹幕相关
  fetchDanmakuList: '/api/douyin/works/:aweme_id/danmaku'
} as const
...
export const BilibiliApiRoutes = {
  // 视频相关
  fetchVideoInfo: '/api/bilibili/videos/:bvid/info',
  fetchVideoStreamUrl: '/api/bilibili/videos/:avid/stream',
  fetchVideoDanmaku: '/api/bilibili/videos/:cid/danmaku',

  // 评论相关
  fetchComments: '/api/bilibili/comments/:oid',
  fetchCommentReplies: '/api/bilibili/comments/:oid/replies/:root',

  // 用户相关
  fetchUserCard: '/api/bilibili/users/:mid/card',
  fetchUserDynamicList: '/api/bilibili/users/:mid/dynamics',
  fetchUserSpaceInfo: '/api/bilibili/users/:mid/space',
  fetchUploaderTotalViews: '/api/bilibili/users/:mid/total-views',

  // 动态相关
  fetchDynamicDetail: '/api/bilibili/dynamics/:dynamic_id/detail',
  fetchDynamicCard: '/api/bilibili/dynamics/:dynamic_id/card',

  // 番剧相关
  fetchBangumiInfo: '/api/bilibili/bangumi/:id/info',
  fetchBangumiStreamUrl: '/api/bilibili/bangumi/:ep_id/stream',

  // 直播相关
  fetchLiveRoomInfo: '/api/bilibili/live/rooms/:room_id/info',
  fetchLiveRoomInitInfo: '/api/bilibili/live/rooms/:room_id/init',

  // 专栏相关
  fetchArticleContent: '/api/bilibili/articles/:id/content',
  fetchArticleCards: '/api/bilibili/articles/cards',
  fetchArticleInfo: '/api/bilibili/articles/:id/info',
  fetchArticleListInfo: '/api/bilibili/article-lists/:id/info',

  // 认证相关
  fetchLoginStatus: '/api/bilibili/auth/status',
  requestLoginQrcode: '/api/bilibili/auth/qrcode/request',
  checkQrcodeStatus: '/api/bilibili/auth/qrcode/:qrcode_key/status',

  // 工具相关
  convertAvToBv: '/api/bilibili/tools/convert/av-to-bv',
  convertBvToAv: '/api/bilibili/tools/convert/bv-to-av',

  // 表情相关
  fetchEmojiList: '/api/bilibili/emojis',

  // 验证码相关
  requestCaptchaFromVoucher: '/api/bilibili/captcha/request',
  validateCaptchaResult: '/api/bilibili/captcha/validate'
} as const
...
export const KuaishouApiRoutes = {
  fetchVideoWork: '/api/kuaishou/works/:photoId',
  fetchWorkComments: '/api/kuaishou/works/:photoId/comments',
  fetchEmojiList: '/api/kuaishou/emojis'
} as const
...
export const XiaohongshuApiRoutes = {
  fetchHomeFeed: '/api/xiaohongshu/feed/home',
  fetchNoteDetail: '/api/xiaohongshu/notes/:note_id',
  fetchNoteComments: '/api/xiaohongshu/notes/:note_id/comments',
  fetchUserProfile: '/api/xiaohongshu/users/:user_id/profile',
  fetchUserNoteList: '/api/xiaohongshu/users/:user_id/notes',
  fetchEmojiList: '/api/xiaohongshu/emojis',
  searchNotes: '/api/xiaohongshu/search/notes'
} as const
...
export function getApiRoute<T extends Platform> (
  ...
  return (routes[platform] as Record<string, string>)[englishMethod]
}
