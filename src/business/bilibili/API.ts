import { BilibiliAPIParams, BilibiliDataOptionsMap } from 'amagi/types'
...
class BiLiBiLiAPI {
  ...
  评论区明细 (data: BilibiliDataOptionsMap['评论数据']) {
  ...
  二维码状态 (data: BilibiliDataOptionsMap['二维码状态']) {
