...
```
@Docs https://ikenxuan.github.io/amagi/llms-full.txt
```

或在聊天中直接引用：

```
使用 Amagi 文档：https://ikenxuan.github.io/amagi/llms.txt
```
...
```
参考 Amagi 文档：https://ikenxuan.github.io/amagi/llms-full.txt
```
...
2. 添加 URL：`https://ikenxuan.github.io/amagi/llms.txt`
...
1. 在 AI Assistant 聊天中直接引用：
   ...
   ```
   参考文档：https://ikenxuan.github.io/amagi/llms-full.txt
   ```
...
```
@workspace 使用 Amagi 文档：https://ikenxuan.github.io/amagi/llms.txt
```
...
```
https://ikenxuan.github.io/amagi/llms.txt
```

<Callout type="info">对于完整文档内容，使用 `/llms-full.txt`</Callout>
...
```
https://ikenxuan.github.io/amagi/docs/v7/usage/getting-started.mdx
https://ikenxuan.github.io/amagi/docs/v7/usage/guide/sdk.mdx
https://ikenxuan.github.io/amagi/docs/v7/usage/api/sdk/bilibili.mdx
```
