...
或使用 MCP Server 获得更强大的文档访问能力（参见 [MCP Server 文档](/docs/v6/ai/mcp-server)）。
...
2. 或使用 MCP Server 获得更强大的集成（参见 [MCP Server 文档](/docs/v6/ai/mcp-server)）
...
- [MCP Server](/docs/v6/ai/mcp-server) — 更强大的 AI 集成方式
