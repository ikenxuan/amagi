...
describe('openapi: true 时自托管规范', () => {
  it('/openapi.json 返回 65 条 path 的 OpenAPI 3.1 规范', async () => {
    ...
    expect(Object.keys(spec.paths)).toHaveLength(65)
...
describe('v7 门面的 startServer 第二参 { openapi }（阶段 9.1，与 v6 门面同款）', () => {
  it('{ openapi: true } 下 /openapi.json 返回 65 条 path 的 OpenAPI 3.1 规范', async () => {
