 ...
 */
export const defineXiaohongshuEndpoint = <TParams extends zod.ZodType, TData = unknown>(
  def: EndpointDef<TParams, TData, XiaohongshuSignerName>
): EndpointDef<TParams, TData, XiaohongshuSignerName> => defineEndpoint(def)
