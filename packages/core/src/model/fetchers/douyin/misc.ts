...
): Promise<Result<ConditionalReturnType<DouyinReturnTypeMap['musicInfo'], M>>> {
  return fetchDouyinInternal('musicInfo', options, { cookie, requestConfig })
}
...
export async function fetchLiveRoomInfo<M extends TypeMode = 'loose'> (
  ...
  cookie?: string,
  requestConfig?: RequestConfig
): Promise<Result<ConditionalReturnType<DouyinReturnTypeMap['liveRoomInfo'], M>>> {
  return fetchDouyinInternal('liveRoomInfo', options, { cookie, requestConfig })
}
...
export async function requestLoginQrcode<M extends TypeMode = 'loose'> (
  ...
  cookie?: string,
  requestConfig?: RequestConfig
): Promise<Result<ConditionalReturnType<DouyinReturnTypeMap['loginQrcode'], M>>> {
  return fetchDouyinInternal('loginQrcode', options, { cookie, requestConfig })
}
...
export async function fetchEmojiList<M extends TypeMode = 'loose'> (
  ...
  cookie?: string,
  requestConfig?: RequestConfig
): Promise<Result<ConditionalReturnType<DouyinReturnTypeMap['emojiList'], M>>> {
  return fetchDouyinInternal('emojiList', {}, { cookie, requestConfig })
}
