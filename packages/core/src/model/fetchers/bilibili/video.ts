...
export async function fetchVideoInfo<M extends TypeMode = 'loose'> (
  ...
  return fetchBilibiliInternal('videoInfo', options, { cookie, requestConfig })
}
...
export async function fetchVideoStreamUrl<M extends TypeMode = 'loose'> (
  ...
  return fetchBilibiliInternal('videoStream', options, { cookie, requestConfig })
}
...
export async function fetchVideoDanmaku<M extends TypeMode = 'loose'> (
  ...
  return fetchBilibiliInternal('videoDanmaku', options, { cookie, requestConfig })
}
