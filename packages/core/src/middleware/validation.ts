 ...
 */
export const createValidationMiddleware = <T>(validateFn: (methodType: T, params: unknown) => any, methodType: T) => {
 ...
 * @returns Express中间件函数
 */
export const createDouyinValidationMiddleware = <T extends DouyinMethodType>(methodType: T) =>
 ...
 * @returns Express中间件函数
 */
export const createBilibiliValidationMiddleware = <T extends BilibiliMethodType>(methodType: T) =>
 ...
 * @returns Express中间件函数
 */
export const createKuaishouValidationMiddleware = <T extends KuaishouMethodType>(methodType: T) =>
 ...
 * @returns Express中间件函数
 */
export const createXiaohongshuValidationMiddleware = <T extends XiaohongshuMethodType>(methodType: T) =>
