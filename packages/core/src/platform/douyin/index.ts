...
type douyinUtilsModel = {
  /** 签名算法相关 */
  sign: typeof import('../../platform/douyin/sign').douyinSign
   ...
   */
  passport: typeof import('../../platform/douyin/passport')
   ...
   */
  douyinApiUrls: typeof import('../../platform/douyin/API').douyinApiUrls
}
