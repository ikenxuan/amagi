...
const KUAISHOU_HUDR_CHACHA_KEY = [4183807412, 394484062, 1106561997, 2378328696, 630790222, 2546784104, 2891127470, 1922531795] as const
const KUAISHOU_HUDR_CHACHA_NONCE = [2215853858, 1643070585, 1849059804] as const
...
export const deriveKuaishouHudrBody = (context: KuaishouHudrContext): KuaishouHudrResult => {
  ...
  const cipher = new KuaishouChaChaCipher(KUAISHOU_HUDR_CHACHA_KEY, KUAISHOU_HUDR_CHACHA_NONCE)
