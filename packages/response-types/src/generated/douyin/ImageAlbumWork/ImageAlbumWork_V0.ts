...
//
// 证据：3 份响应（amagi 6.6.0）。参数与说明在 corpus/douyin/imageAlbumWork.requests.json 里
//   aweme_id  单live photo
//   aweme_id  常见默认值2
//   aweme_id  默认值

export type ImageAlbumWork_V0 = {
...
type Image = {
  ...
  resolution_log_param: { [property: string]: any }
  uri: string
  url_list: string[]
  video?: Video
  width: number
...
type Video = {
  ...
  download_suffix_logo_addr: AvatarThumb
  duration: number
